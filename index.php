    	...
    	<div class="container">
	    	<div class="row">
		    	...
		    	<div class="col s6  right-align">
		    		<br>
		    		<span style="font-size: 25px;" class="light"><strong>Atualizado em:</strong><br> 23:30 16/04/2020</span>
		    	</div>
	    	</div>
    	</div>
    </section>
          ...
          <div class="col s12 m12 l4">
            ...
            <div class="col s12 m4 l12">
              ...
              <div class="card-content">
                <div class="card-title"><button class="btn-floating btn-large" style="margin-right: 8px; background: #5d78ff; font-weight: bold; font-size: 1.5rem;"><?php echo end($qtdUba); ?></button> <span class="light" >Casos Confirmados</span></div>
            ...
            <div class="card "  style="border-radius: 10px; ">
              ...
              <div class="card-content ">
                <div class="card-title"><button class="btn-floating red btn-large" style="margin-right: 8px; font-weight: bold; font-size: 1.5rem;"><?php echo end($mortesUba); ?></button> <span class="light" >Óbitos Confirmados</span></div>
           ...
           <div class="col s12 m4 l12">
             ...
             <div class="card "  style="border-radius: 10px; ">
              ...
              <div class="card-content ">
                ...
                </button> <span class="light" >Letalidade</span></div>
    			...
    			<div class="col s12 m12 l12">
    				<div class="card" style="border-radius: 10px; ">
    					...
    					<div class="card-action">
    						<canvas id="minas" width="400" height="220"></canvas>
    ...
    <footer class="back-footer">
            ...
            <div class="container center white-text">
              <div class="" style="padding: 30px 0;">
                <div class="col s12"> © 2020 - Painel de casos de doença pelo coronavírus 2019 (COVID-19) na cidade de Ubá, Minas Gerais e no Brasil</div>
              </div>
